...
public class Constants {
	...
	public static final String INTENT_ACTION_LOCATION_UPDATE_MAP = "location.update.map.action";
	public static final String INTENT_ACTION_LOCATION_UPDATED = "location.updated.action";
